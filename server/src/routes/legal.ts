  ...
  res.type('html').send(
    page(
      ...
      <ul>
        ...
        <li><strong>Konum (opsiyonel):</strong> Biz sekmesinden konum paylaşımını açarsan, cihazının enlem/boylamını sunucuya göndeririz. "Her zaman izin ver" konum iznini verirsen bu, konumunu güncel tutmak için <strong>uygulama kapalıyken/arka plandayken de</strong> periyodik olarak (birkaç dakikada bir ya da belirgin bir konum değişikliğinde) gönderilir; yalnızca "uygulamayı kullanırken" izni verirsen paylaşım sadece uygulamayı her açtığında gerçekleşir. Bu paylaşım <strong>karşılıklıdır</strong>: sen ve partnerin ikiniz de açtığınızda, birbirinizin anlık konumunu uygulama içindeki haritada canlı olarak görebilirsiniz ve aranızdaki mesafe de gösterilir; yalnızca biriniz açarsa diğeriniz hiçbir konum bilgisi göremez. Bunu <strong>istediğin zaman kapatabilirsin</strong>; kapatınca hem arka plan takibi durur hem de sunucudaki kayıt silinir.</li>
      ...
      <p><strong>Konumun yalnızca karşılıklı paylaşımla gösterilir.</strong> Konum paylaşımını açtığında, kendi enlem/boylamın yalnızca partnerin de aynı ayarı açtıysa ona (uygulama içindeki haritada, canlı olarak) ve aranızdaki hesaplanmış mesafeye (km) yansıtılır; sen açıp partnerin açmadıysa (ya da tam tersi), hiçbir taraf diğerinin konumunu göremez ve enlem/boylam üçüncü bir kişiyle ya da başka bir amaçla paylaşılmaz. <strong>"Sürüş takibi"</strong> ayrı ve bilerek açman gereken bir seçenektir: bunu açarsan, sürüş halindeyken kesin konumun (hız ve izlediğin yol) partnerine tek taraflı ve canlı olarak gösterilir; bu özellik varsayılan olarak kapalıdır ve istediğin zaman kapatılabilir.</p>
      ...
      <ul>
        ...
        <li>İkiniz de konum paylaşımını açtıysanız, anlık konumunuzu haritada birbirinize göstermek ve aranızdaki mesafeyi hesaplamak.</li>
